...
export default function HowWork() {
  return (
    <>
      <Welcome>
        <ListHeroBanner title={"Working Process"} active={"Working Process"} />
        {/* <!--====== Start Intro Section ======--> */}
        <section className="intro-area pt-115">
          <div className="container">
            ...
            <div
              className="intro-wrppaer-two bg_cover"
              style={{
                backgroundImage: "url(assets/images/bg/video-bg-2.jpg)",
              }}
            >
                    ...
                    <div className="col-lg-6">
                      <div className="process-content-box">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Be seed saying our sign beginning face give spirit
                            own beast and a darkness morning moveth green
                            multipl she doin kind saying one shall, two which
                            darkness have day image god their night his feed
