...
export default function AddingList() {
  return (
    <>
      <Welcome>
          <ListHeroBanner title={"Add Listing"} active={"Listing"} />
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form_group">
                                            ...
                                            </select><div className="nice-select wide" tabIndex="0"><span className="current">Museums</span><ul className="list"><li data-value="01" className="option selected">Museums</li><li data-value="02" className="option">Restaurant</li><li data-value="03" className="option">Party Center</li><li data-value="04" className="option">Fitness Zone</li><li data-value="05" className="option">Game Field</li><li data-value="06" className="option">Job &amp; Feeds</li><li data-value="07" className="option">Shooping</li><li data-value="08" className="option">Art Gallery</li></ul></div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="form_group">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form_group">
                                            <textarea className="form_control" placeholder="Description" name="discription"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
