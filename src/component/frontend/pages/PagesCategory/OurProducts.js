...
export default function OurProducts() {
  return (
    <>
      <Welcome>
        <ListHeroBanner title={"Our Store"} active={"Our Store"} />
                  ...
                  <div className="sort-dropdown d-flex align-items-center">
                    ...
                    <div className="products-dropdown">
                      ...
                      <div className="nice-select wide" tabIndex={0}>
                        ...
                        <ul className="list">
                          <li data-value="default" className="option selected">
                            Default Sorting
                          </li>
                          <li data-value="new" className="option">
                            Newest Product
                          </li>
                          <li data-value="old" className="option">
                            Oldest Product
                          </li>
                          <li data-value="hight-to-low" className="option">
                            High To Low
                          </li>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Hand Dumbell</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Green Plastic Light</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Leaser Photography</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Nike Sports Shoe</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Room Decorator</a>
                      </h3>
                      <span className="price">$320.00</span>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Card Showcase</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Hand Watch</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Realstic Dumbell</a>
                      </h3>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12">
                  <div className="products-item products-item-one mb-25">
                    ...
                    <div className="product-info text-center">
                      <h3 className="title">
                        <a href="products-details.html">Hand Speaker</a>
                      </h3>
