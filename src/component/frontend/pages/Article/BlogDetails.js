...
export default function BlogDetails() {
  return (
    <>
      <Welcome>
        <ListHeroBanner title={"Blog Single"} active={"Blog Single"} />
            ...
            <div className="row">
                  ...
                  <div className="blog-post-item">
                    ...
                    <div className="entry-content">
                      ...
                      <p>
                        ...
                        sollicitudin placerat an tempus turpis magnis tempus
                        inte vivamus rhoncus roin habitasse diam mattis vivamus
                        per. Neque nibh purus, donec taciti donec parturient Nec
                        neque facilisi etiam nibh urna taciti tortor auctor
                        ullamcorper ridiculus hendrerit duis accumsan iaculis
                        elit per gravida vel gravida magnis pretium hac litora
                        eu molestie aptent. Eget mollis vehicula cursus ate
                        netus iaculis vel praesent aliquam malesuada faucibus in{" "}
                        <span className="highlight">condimentum</span> egestas
                        vivamus quisque condimen tum purus dapibus accumsan
                        fames nisi dapibus ultrices velit urna. Enim fats etiam
                        elementum ipsum sem netus dapibus molestie dictum
                        aenean. Montes ridiculus bibendum malesuada cras nisi
                        nibh porttitor site facilisi lacinia consequat integer
                        sed mattis nec ultricies vulputate velit congue pede
                        nceptos elit vulputat metus suspendisse faller the
                        sociology nullam.
                      </p>
                      <p>
                        ...
                        aliquam malesuada faucibus in condimentum egestas
                        vivamus quisque condimen drutum purus dapibus accumsan
                        fames nisi dapibus ultrices velit urna. Enim fats etiam
                        elementum ipsum sem netus dapibus fallen molestie dictum
                        aenean. Montes ridiculus{" "}
                        <span className="highlight">bibendum</span> malesuada
                        cras nis nibh porttitor site facilisi lacinia consequat
                        integer sed mattis nec ultricies vulputate velit congue
                        pede nceptos elit vulputat{" "}
                      </p>
                      ...
                      <p>
                        ...
                        dictumst placerat sed cum vivamus tellus consequat
                        magnis dis auctor hymenaeos turpis et metus orci th
                        aliquet fermentum tincidunt parturient eget montes
                        convallis nunc lacus feugiat nonummy sociis phasellus
                        etiam auctor inte justo semper volutpat mi morbi ornare
                      </p>
                      ...
                      <p>
                        Consequat magnis dis auctor hymenaeos turpis et metus
                        orci th aliquet fermentum tincidunt parturient eget
                        montes convallis nunc lacus feugiat nonummy sociis
                        phasellus etiam auctor inte justo semper voluter pat mi
                        morbi ornare nunc{" "}
                      </p>
                      <ul className="list">
                        <li className="item">
                        ...
                        <li className="item">
                          Adipiscing mattis dis risus rutrum feugiat maecenas
                          nunc nullam congue pe placerat potenti hendreri felis
                          odio ad dignissim posuere.
                        </li>
                      </ul>
              ...
              <div className="col-lg-4">
                <div className="sidebar-widget-area">
                  <div className="widget search-widget mb-30">
                  ...
                  <div className="widget categories-widget mb-30">
                  ...
                  <div className="widget recent-post-widget mb-30">
                  ...
                  <div className="widget add-widget mb-30">
                  ...
                  <div className="widget tag-cloud-widget mb-30">
